...
impl IComposition for ETH_SMA_200_4H_4Y {
    fn id(&self) -> &str {
        return &self.id;
    }
...
impl ETH_SMA_200_4H_4Y {
    pub fn instance() -> &'static ETH_SMA_200_4H_4Y {
        static INSTANCE: OnceLock<ETH_SMA_200_4H_4Y> = OnceLock::new();
        return INSTANCE.get_or_init(|| ETH_SMA_200_4H_4Y::new());
    }
